...
def Panoptes3(inputa, inputb, inputc, demographics=None,
               dropout=0.8, num_cls=1000, is_train=True, scope='Panoptes3', supermd=False):
    with tf.variable_scope(scope, 'Panoptes3', [inputa, inputb, inputc]):
